...
# deploy the files
Get-ChildItem -Path '.\deploy\blog\site' -File -Recurse | Set-AzStorageBlobContent -Container '$web' -Context $storageAccount.Context -Properties @{ ContentType = "text/html; charset=utf-8"; } -Force
