...
![solution design diagram](/custom-availability-test-design.png)
...
<Gist id="45be49f43884ae49ef582263dec176b6" file="function.json" />
...
<Gist id="45be49f43884ae49ef582263dec176b6" file="run.ps1" />
...
![availability test success screenshot](/availability-test-success-screenshot.png)

Unless there's a problem with your application of course - let's see what happens when I stop the web app:

![availability test fail screenshot](/availability-test-fail-screenshot.png)
